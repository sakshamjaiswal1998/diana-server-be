const Event = require('../models/press1Model');
const multer = require('multer')
const upload = multer({ dest: 'uploads/' })

const getAllPress1 = async (req, res) => {
    try {
...
const getPress1ById = async (req, res) => {
    try {
...
const createPress1 = async (req, res) => {
...
const updatePress1ById = async (req, res) => {
    // console.log(req.file, req.body, req.files, 'FILE/BODY/FILES')
    // let temp = req.body;
    try {
...
const removePress1 = async (req, res) => {
    try {
